...
#define BROADCOM              6
#define MEDIATEK              7
#define BROADCOM_MT           8
#define XORSHIFT32            9
#define WINCE_LCG            10
#define NUMRECIPES_LCG       11
...
const char *p_mode_name[MODE_LEN + 1] = { "", "RT/MT/CL", "eCos simple", "RTL819x", "eCos simplest", "eCos Knuth", "Broadcom", "MediaTek MT76xx", "Broadcom MT19937", "XorShift32", "Windows CE", "Num. Recipes" };
...
char v_usage[] =
    "\n"
    " Pixiewps %s WPS pixie-dust attack tool\n"
    " Copyright (c) 2015-2017, wiire <wi7re@gmail.com>\n"
    "\n"
...
/* Comma separated number parsing (supports multi-digit mode numbers) */
static inline uint_fast8_t parse_mode(char *list, uint_fast8_t *dst, const uint8_t max_val)
{
    uint_fast8_t cnt = 0;
    while (*list != 0) {
        if (*list < '0' || *list > '9')
